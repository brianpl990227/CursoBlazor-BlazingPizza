...
namespace BlazingPizza.UI.Shared
{
    public class Address
    {
        ...
        [Required(ErrorMessage = "Es necesario especificar dirección de envío"), MaxLength(100)]
        ...
        [Required(ErrorMessage = "El código postal debe ser especificado"), MaxLength(20)]
